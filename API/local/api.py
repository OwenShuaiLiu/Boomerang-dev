...
def request_consignment():
	...
	cursor_user.execute("INSERT INTO users (email_addr, phone, addr_1, addr_2, city, zip_code, state, consignment_request_no, user_no) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)", ([user_email_addr], [user_phone], [user_addr_1], [user_addr_2], [user_city], [user_zip_code], [user_state], [tran_request], [user_no]))
